   ...
   public static double jc_lsi;
    ...
    public static void main(String[] args) throws Exception {
       ...
       int   i=0;
                    ...
                    while((s=br.readLine())!=null)
                    {
                      ...
                      keywordList.addAll(key_back);
                       st = new StringTokenizer(s, "\t", false);
                          ...
                          // System.out.println(temp);
                           ...
                           else
                           {
                                ...
                                //keyword_array
                                   ...
                                   // System.out.println(t+keywordDoc.indexOf(t));
                          ...
                          /* for(i=0;i<keywordDoc.size();++i)
                              System.out.println(keywordDoc.get(i)); */
                 ...
                 //System.out.println("jaccard"+jc_tdidf);
            ...
            //System.out.println("jaccard"+jc_lsi);
                           //tM.computeSVD();
                           out.close();
